...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  @NonNull
  public final Button btnMovesignup;
  ...
  private ActivityLoginBinding(@NonNull LinearLayout rootView, @NonNull Button btnLogin,
      @NonNull Button btnMovesignup, @NonNull EditText edtPassword, @NonNull EditText edtUsername) {
    this.rootView = rootView;
    this.btnLogin = btnLogin;
    this.btnMovesignup = btnMovesignup;
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btn_movesignup;
      Button btnMovesignup = ViewBindings.findChildViewById(rootView, id);
      if (btnMovesignup == null) {
        break missingId;
      }
      ...
      return new ActivityLoginBinding((LinearLayout) rootView, btnLogin, btnMovesignup, edtPassword,
          edtUsername);
    }
